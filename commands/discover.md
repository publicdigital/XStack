...
You are about to scaffold a discovery for a government service. Hand off to the **service-designer** agent, supported by the **delivery-manager** for stakeholder mapping, using the **xstack:discovery-kit** skill.
...
- Team available – which disciplines are already in, which gaps need filling (Multidisciplinary team)
...
2. **Stakeholder map** – citizens, the owning department, other government, outside government, senior decision-makers
